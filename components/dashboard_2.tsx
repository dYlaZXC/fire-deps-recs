                  ...
                  <p className="text-xs text-muted-foreground">
                     {(() => {
                       ...
                       const currentValue = getCurrentScenarioData().populationCoverage
                          ...
                          const baselineValue = currentData?.populationCoverage || 0
                        ...
                        if (selectedScenario === "planned16" || selectedScenario === "aiRecommended") {
                          const currentBaseline = currentData?.populationCoverage || 0
                          const planned5Baseline = planned5Data?.populationCoverage || 0
                  ...
                  <p className="text-xs text-muted-foreground">
                     {(() => {
                       ...
                       const currentValue = getCurrentScenarioData().incidentCoverage
                                               ...
                                               if (selectedScenario === "planned5") {
                          const baselineValue = currentData?.incidentCoverage || 0
                          const improvement = currentValue - baselineValue
                          return `+${improvement.toFixed(2)}% от текущей ситуации (${baselineValue}%)`
                        }
                        
                        if (selectedScenario === "planned16" || selectedScenario === "aiRecommended") {
                          const currentBaseline = currentData?.incidentCoverage || 0
                          const planned5Baseline = planned5Data?.incidentCoverage || 0
                  ...
                  <p className="text-xs text-muted-foreground">
                     {(() => {
                       ...
                       const currentValue = getCurrentScenarioData().highRiskCoverage
                                               ...
                                               if (selectedScenario === "planned5") {
                          const baselineValue = currentData?.highRiskCoverage || 0
                          const improvement = currentValue - baselineValue
                          return `+${improvement.toFixed(2)}% от текущей ситуации (${baselineValue}%)`
                        }
                        
                        if (selectedScenario === "planned16" || selectedScenario === "aiRecommended") {
                          const currentBaseline = currentData?.highRiskCoverage || 0
                          const planned5Baseline = planned5Data?.highRiskCoverage || 0
